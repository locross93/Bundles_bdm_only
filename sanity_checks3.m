function [LM_leftright, LM_foodtrinket ] = sanity_checks3(subjectID,saveflag)
...
ylim([0 20]);
text(0.5,18,sprintf('R2 value: %0.3f \n\\beta1: %0.3f \n\\beta2: %0.3f \n\\beta3: %0.3f', LM_leftright.Rsquared.Ordinary, beta(1), beta(2), beta(3)));
...
LM_foodtrinket=fitlm(zscore([bdm_mixedbundle_item_values bdm_mixedbundle_similarity]),zcore(bdm_mixedbundle_value),'VarNames',{'FoodValue','TrinketValue','ItemSimilarity','BundleValue'},'Intercept',false)
...
xlim([0 max([PredictedValues; 20])])
ylim([0 20]);
text(0.5,18,sprintf('R2 value: %0.3f \n\\beta1: %0.3f \n\\beta2: %0.3f \n\\beta3: %0.3f', LM_foodtrinket.Rsquared.Ordinary, beta(1), beta(2),beta(3)));
