function [LM_leftright, LM_foodtrinket ] = sanity_checks2(subjectID,saveflag)

%Works as of 6/21/2018
...
LM_leftright=fitlm([bdm_bundle_item_values],bdm_bundle_value,'VarNames',{'LeftItemValue','RightItemValue','BundleValue'},'Intercept',false)
...
LM_foodtrinket=fitlm([bdm_mixedbundle_item_values],bdm_mixedbundle_value,'VarNames',{'FoodValue','TrinketValue','BundleValue'},'Intercept',false)
...
xlim([0 max([PredictedValues; 20])])
ylim([0 20]);
text(0.5,18,sprintf('R2 value: %0.3f \n\\beta1: %0.3f \n\\beta2: %0.3f', LM_foodtrinket.Rsquared.Ordinary, beta(1), beta(2)));
