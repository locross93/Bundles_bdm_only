...
function LinearModels=WG_analysis_pilotdata_v2(subjectsToAnalyze)
...
Variable_Names={'LeftItemValue','RightItemValue','ItemSimilarity','BundleValue'}
...
Variable_Names={'FoodValue','TrinketValue','ItemSimilarity','BundleValue'};
...
for bdm_class=1:2
    ...
    VariableNames={'LeftItemValue','RightItemValue','ItemSimilarity','BundleValue'};
