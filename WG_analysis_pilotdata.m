...
function WG_analysis_pilotdata(subjectsToAnalyze)
...
for bdm_class=1:2
    LM_class_leftright=fitlm(bdm_bundle_ItemValue(bdm_bundle_class==bdm_class,:),bdm_bundle_value(bdm_bundle_class==bdm_class),'VarNames',{'LeftItemValue','RightItemValue','BundleValue'},'Intercept',false)
    fprintf('%s R2 value: %f \n',bdm_class_names{bdm_class+1}, LM_class_leftright.Rsquared.Ordinary);
    beta=LM_class_leftright.Coefficients.Estimate;
    figure(1);
